...
const chrono::duration UI_TICK_INTERVAL = 5s;
const chrono::duration AUTO_REFRESH_INTERVAL = 2min;
const chrono::duration MANUAL_REFRESH_INTERVAL = 1min;
...
const ImVec4 COLOR_CURRENCY_GOLD = ImVec4(246 / 255.f, 206 / 255.f, 91 / 255.f, 255 / 255.f);
const ImVec4 COLOR_CURRENCY_SILVER = ImVec4(199 / 255.f, 197 / 255.f, 199 / 255.f, 255 / 255.f);
const ImVec4 COLOR_CURRENCY_COPPER = ImVec4(170 / 255.f, 90 / 255.f, 23 / 255.f, 255 / 255.f);
...
const std::string CONFIG_JSON_FILENAME = "search.json";
...
const std::map<std::string, int> ENDPOINT_SORT_ORDER = { {"/account/bank", 1}, {"/account/inventory", 2}, {"/character", 3}, {"/account/materials", 4} };
